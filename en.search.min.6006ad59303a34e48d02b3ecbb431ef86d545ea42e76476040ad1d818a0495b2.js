...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notebook/flexsearch.min.js');loadScript('/notebook/en.search-data.min.41417ea10e34a4b09492a01e4b4604809ed3d6f69a0898a326e5b981431c12aa.js',function(){input.required=false;search();});}
