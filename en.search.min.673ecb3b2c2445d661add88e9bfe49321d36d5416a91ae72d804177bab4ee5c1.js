...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.46398a123055caf7e7a779701b60d2e3948a27cd7b8560aeab27819a447d4ab9.js',function(){input.required=false;search();});}
