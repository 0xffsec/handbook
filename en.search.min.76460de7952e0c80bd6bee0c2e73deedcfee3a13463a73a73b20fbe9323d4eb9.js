...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/book/flexsearch.min.js');loadScript('/book/en.search-data.min.033a4a46f9e40629a86bc24bf6e21d9981567786aede3b115ffa90b68476e36f.js',function(){input.required=false;search();});}
