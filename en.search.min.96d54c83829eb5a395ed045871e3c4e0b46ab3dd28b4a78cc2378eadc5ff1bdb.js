...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/handbook/flexsearch.min.js');loadScript('/handbook/en.search-data.min.987042e6fb005bd915d8670817134ec114f00fcbc91921b21f707e185df5bc05.js',function(){input.required=false;search();});}
