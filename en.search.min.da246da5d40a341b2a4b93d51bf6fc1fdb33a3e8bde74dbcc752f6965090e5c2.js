'use strict';(function(){const searchDataURL='https://0xffsec.com/handbook/en.search-data.min.bfabc897c6e7d0996750b503b2c4cc27fc912ffe678af8d5c402490e7da4ec4a.json';console.log(searchDataURL);const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
