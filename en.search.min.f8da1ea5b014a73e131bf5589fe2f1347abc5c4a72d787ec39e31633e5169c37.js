...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notebook/flexsearch.min.js');loadScript('/notebook/en.search-data.min.6fa48c1b0a3fba4e7a5d7f1e6343286ae207a508dafd43a3a456af8130f24ee0.js',function(){input.required=false;search();});}
